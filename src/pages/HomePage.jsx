      ...
      <section className="relative overflow-hidden pb-24 pt-8">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 relative">
            <div
              className="hidden lg:block w-[300px] xl:w-[340px] 2xl:w-[380px] h-[560px] rounded-3xl overflow-hidden border-4 border-white shadow-xl lg:absolute lg:top-4 lg:z-10 lg:left-[-176px] xl:left-[-128px] 2xl:left-[-96px]"
            >
            ...
            <div
              className="hidden lg:block w-[300px] xl:w-[340px] 2xl:w-[380px] h-[560px] rounded-3xl overflow-hidden border-4 border-white shadow-xl lg:absolute lg:top-4 lg:z-10 lg:right-[-176px] xl:right-[-128px] 2xl:right-[-96px]"
            >
