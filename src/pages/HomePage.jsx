      ...
      <section className="relative overflow-hidden pb-24 pt-8">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 relative">
            <div
              className="hidden lg:block w-[300px] xl:w-[380px] 2xl:w-[420px] min-[1900px]:w-[470px] h-[560px] rounded-3xl overflow-hidden border-4 border-white shadow-xl lg:absolute lg:top-4 lg:z-10 lg:left-[-320px] xl:left-[-290px] 2xl:left-[-250px]"
            >
            ...
            <div
              className="hidden lg:block w-[300px] xl:w-[380px] 2xl:w-[420px] min-[1900px]:w-[470px] h-[560px] rounded-3xl overflow-hidden border-4 border-white shadow-xl lg:absolute lg:top-4 lg:z-10 lg:right-[-320px] xl:right-[-290px] 2xl:right-[-250px]"
            >
